...
<body>
  <nav class="navbar navbar-expand-lg" style="background: linear-gradient(rgba(9, 165, 255, 0.80), rgba(0, 225, 255, 0.75));">
    <div class="container-fluid">
      <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
        <img src="../../photo/images.jpg" alt="Menu" class="img-fluid"><span class="rct">BEED</span>
      </button>
  ...
  <div class="container mt-4">
    <h3 class="mb-4" style="color: white">Instructors for BEED</h3>
        ...
        fetch('../../admin/create list/fetch_instructors_for_course.php?course=beed')
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    ...
                    listHTML += '<p>No instructors found for BEED.</p>';
                }
