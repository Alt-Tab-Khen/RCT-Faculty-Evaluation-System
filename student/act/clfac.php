...
<body>
  <nav class="navbar navbar-expand-lg" style="background: linear-gradient(rgba(9, 165, 255, 0.80), rgba(0, 225, 255, 0.75));">
    <div class="container-fluid">
      <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
        <img src="../../photo/images.jpg" alt="Menu" class="img-fluid"><span class="rct">ACT</span>
      </button>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <div class="d-flex w-100 justify-content-end align-items-center">
          <ul class="navbar-nav">
            ...
            <li class="btn-group">
              <a type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                Section
              </a>
  ...
  <div class="container mt-4">
    <h3 class="mb-4" style="color: white">Instructors for ACT</h3>
  ...
  <div class="offcanvas-body">
    <div class="but">
      <ul class="dropdown" id="it">
        <li><a href="../act/admin.php" type="button" class="btn" id="cl">Dashboard</a></li>
        <li><a href="../act/clfac.php" type="button" class="btn" id="cl">Instructor List</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchInstructorsForCourse() {
        fetch('../../admin/create list/fetch_instructors_for_course.php?course=act')
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    ...
                    listHTML += '<p>No instructors found for ACT.</p>';
                }
