...
<body>
      ...
      <div class="row">
            <div class="col-12">
                <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
                    <img src="../../photo/images.jpg" alt="Menu" class="img-fluid"><span class="rct">BSCS</span>
                </button>
            </div>
        </div>
    </div>
  ...
  <div class="container mt-4">
    <h3 class="mb-4" style="color: white">Instructors for BSCS</h3>
  ...
  <div class="offcanvas-body">
    <div class="but">
      <ul class="dropdown" id="it">
        <li><a href="../bscs/admin.php" type="button" class="btn" id="cl">Dashboard</a></li>
        <li><a href="../bscs/clfac.php" type="button" class="btn" id="cl">Instructor List</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchInstructorsForCourse() {
        fetch('../../admin/create list/fetch_instructors_for_course.php?course=bscs')
            .then(response => {
                if (!response.ok) {
