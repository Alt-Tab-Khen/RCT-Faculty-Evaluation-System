...
<body>
  <nav class="navbar navbar-expand-lg" style="background: linear-gradient(rgba(9, 165, 255, 0.80), rgba(0, 225, 255, 0.75));">
    <div class="container-fluid">
      <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
        <img src="../../photo/images.jpg" alt="Menu" class="img-fluid"><span class="rct">BSA</span>
      </button>
  ...
  <div class="container mt-4">
    <h3 class="mb-4" style="color: white">Instructors for BSA</h3>
  ...
  <div class="offcanvas-body">
    <div class="but">
      <ul class="dropdown" id="it">
        <li><a href="../bsa/admin.php" type="button" class="btn" id="cl">Dashboard</a></li>
        <li><a href="../bsa/clfac.php" type="button" class="btn" id="cl">Instructor List</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchInstructorsForCourse() {
        fetch('../../admin/create list/fetch_instructors_for_course.php?course=bsa')
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    ...
                    listHTML += '<p>No instructors found for BSA.</p>';
                }
